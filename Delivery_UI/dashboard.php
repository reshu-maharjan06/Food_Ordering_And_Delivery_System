...
<head>
    ...
    <title>Sauni Rider — Dashboard</title>
...
<div class="app-shell">
            ...
            <div id="pane-mission" class="pane active">
                <div id="missionContent">
                    <div class="mission-empty">
                        <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="#d1d5db" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
    ...
    <main class="map-section">
        <div id="map"></div>
        <button class="btn-center" onclick="recenterMap()">
...
<div class="modal" id="finishModal">
    <div class="modal-body">
        ...
        <button class="action-primary btn-deliver btn-modal-close" onclick="closeSuccessModal()">Ready for More</button>
    </div>
</div>
