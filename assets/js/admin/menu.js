...
async function saveMenu() {
    try {
        ...
        alert('Network or server error occurred while saving the menu item: ' + err.message);
    }
}
...
async function deleteItem(id) {
    try {
        ...
        alert('Network or server error occurred while deleting the menu item: ' + err.message);
    }
}
