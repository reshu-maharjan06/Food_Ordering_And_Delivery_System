...
<div class="main-wrapper" id="mainWrapper" style="display:none;">
    <div class="left-col">
        <div class="lc-scroll">
            ...
            <div class="delivery-info">
                ...
                <div class="di-grid">
                    <div>
                        ...
                        <p id="lblPhone"><?= htmlspecialchars($_SESSION['phone'] ?? '9856785650') ?></p>
                    </div>
                    <div>
            ...
            <button id="btnCancelOp" style="display:none; width:100%; padding:15px; margin-top:20px; background:#ff3b00; color:#fff; border:none; border-radius:8px; font-weight:600; cursor:pointer;">Cancel Order</button>
        </div>
    </div>
    <div class="right-col">
        ...
        <div class="delivery-by-card" id="driverPanel" style="display:none;">
            ...
            <div class="db-contact">
                <label>Phone Number</label>
                <a href="#" id="drPhone">9786513602</a>
            </div>
        </div>
    </div>
</div>
<div id="noAct" style="display:flex; flex-direction:column; align-items:center; justify-content:center; height:100vh; padding:1rem; text-align:center;">
    ...
    <button onclick="location.href='browse.php'" style="padding:12px 24px; background:var(--o,#ff3b00); color:#fff; border:none; border-radius:50px; font-weight:600; cursor:pointer; box-shadow:0 5px 15px rgba(255,59,0,0.2);">Browse Menu</button>
</div>
<script src="../assets/js/sauni-cart.js?v=2.2"></script>
<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
<script src="../assets/js/customer/tracker.js?v=2.2"></script>
    <script src="../assets/js/shared/nav.js?v=2.2"></script>
</body>
</html>
