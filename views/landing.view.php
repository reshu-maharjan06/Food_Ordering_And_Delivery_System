...
<body>
    ...
    <header class="nav-wrapper" id="sticky-nav">
        <a href="landing.php" class="logo" style="font-family:'Outfit',sans-serif; font-size:1.6rem; font-weight:900; letter-spacing:0; word-spacing:0; text-decoration:none; color:#ff3b00; display:inline-flex; align-items:center;">S<span style="font-size:1em; line-height:1; display:inline-block; margin:0 -0.15em; vertical-align:-0.05em;">🔥</span>UNI</a>
        <nav>
            <ul>
    ...
    <footer class="classic-footer">
        <div class="footer-grid">
            <div class="f-brand">
                <h2 class="logo" style="font-family:'Outfit',sans-serif; font-weight:900; letter-spacing:0; word-spacing:0; color:#ff3b00; display:flex; align-items:center;">S<span style="font-size:1em; line-height:1; display:inline-block; margin:0 -0.15em; vertical-align:-0.05em;">🔥</span>UNI</h2>
    ...
    <link rel="stylesheet" href="assets/css/customer/assistant.css?v=1.3">
    ...
    <script src="assets/js/customer/assistant.js?v=1.3"></script>
</html>
