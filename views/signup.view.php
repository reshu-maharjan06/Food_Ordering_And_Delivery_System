                ...
                <div>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="input-group" style="margin-bottom: 20px;">
                            ...
                            <select name="role" required style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-family: 'Outfit', sans-serif;">
