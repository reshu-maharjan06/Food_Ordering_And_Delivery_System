...
<nav class="customer-nav">
    <a href="../landing.php" class="cn-logo" onclick="navGo(event,'../landing.php')">
        <img src="../assets/img/logo.png" alt="Sauni Logo" style="height:38px; width:auto; vertical-align:middle; border-radius:10px;">
    </a>
    <div class="cn-links">
        <a href="../landing.php" class="cn-link cn-link-icon <?= $act==='home' ? 'active':'' ?>" onclick="navGo(event,'../landing.php')">
            <svg class="cn-ic" viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
            Home
        </a>
